% Autogenerated file: Sat Jan 18 21:50:43 2025
...
wr = coder.internal.writeDataInterfacesToCodeDescriptor("Path_Planner",pwd) ;
...
skippedParameters = [];
    ...
    func_Initialize_Prototype.Return     = tmpRet;
        ...
        func_Initialize_Prototype.HeaderFile = 'Path_Planner.h';
    func_Initialize_Prototype.SourceFile = 'Path_Planner.cpp';
    ...
    func_Initialize_Interface.ActualReturn = tmpActualReturn;
        ...
        func_Initialize_Prototype.Name = 'Path_Planner_initialize';
    ...
    func_OutputUpdate_Prototype.Return     = tmpRet;
        ...
        func_OutputUpdate_Prototype.HeaderFile = 'Path_Planner.h';
    func_OutputUpdate_Prototype.SourceFile = 'Path_Planner.cpp';
    ...
    func_OutputUpdate_Interface.ActualReturn = tmpActualReturn;
            ...
            func_OutputUpdate_Prototype.Name = 'Path_Planner_step';
    ...
    func_Terminate_Prototype.Return     = tmpRet;
        ...
        func_Terminate_Prototype.HeaderFile = 'Path_Planner.h';
    func_Terminate_Prototype.SourceFile = 'Path_Planner.cpp';
    ...
    time_constant = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, -1));
        func_Terminate_Interface.Timing = time_constant;
                func_Terminate_Prototype.Name = ['Path_Planner_terminate'];
        codeInfo.TerminateFunctions =  [codeInfo.TerminateFunctions, func_Terminate_Interface'];
            ...
            type_RTModel.Identifier = 'RT_MODEL_Path_Planner_T';
        ...
        Var_RTModel = RTW.Variable(Ptrtype_RTModel_1_0.BaseType, 'Path_Planner_M_');
        Var_RTModel.Owner           = 'Path_Planner';
        Var_RTModel.DeclarationFile = 'Path_Planner.h';
            Var_RTModel.DefinitionFile  = 'Path_Planner.cpp';
        

        % Pointer Variable: PtrVar_RTModel
        PtrVar_RTModel = RTW.PointerVariable(Ptrtype_RTModel_1_0, 'Path_Planner_M', Var_RTModel);
